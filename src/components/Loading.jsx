    ...
    return (
        <div className="loading__container">
            <div className="loading__img">
                <svg fill={'#' + ((props.hoverStatus) ? ColorService.getHoverColor(color.color) : color.color)} xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 122.88 122.88">
